    ...
    if educational_slides:
        ...
        for slide in educational_slides:
            ...
            if image_url:  #saves to original json
                #slide_id = slide.get('slide', 'unknown')
                slide_id = slide.get('slide', f'slide_{educational_slides.index(slide) + 1}')
            ...
            # Save the generated image URL and local path into the slide
            slide['generated_image_url'] = image_url
            slide['local_image_path'] = local_image_path
